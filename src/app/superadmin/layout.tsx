...
export default function SuperAdminLayout({
  ...
  const navigation = [
    ...
    { name: "Global Inventory", href: "/superadmin/inventory", icon: Package },
    { name: "Global Orders", href: "/superadmin/orders", icon: ShoppingBag },
    { name: "Commission", href: "/superadmin/commission", icon: DollarSign },
